...
use framebuffer::{Framebuffer, ColorInput};

fn main() -> std::io::Result<()> {
    let mut framebuffer = Framebuffer::new(800, 600);

    framebuffer.set_background_color(ColorInput::Hex(0xADD8E6));
    framebuffer.clear();

    framebuffer.set_current_color(ColorInput::Hex(0xFF0000));
    framebuffer.point(400, 300);
    framebuffer.point(401, 300);
    framebuffer.point(400, 301);
    framebuffer.point(401, 301);

    framebuffer.set_current_color(ColorInput::Hex(0x00FF00));
    framebuffer.point(200, 150);
    framebuffer.point(201, 150);
    framebuffer.point(200, 151);
    framebuffer.point(201, 151);

    framebuffer.set_current_color(ColorInput::Hex(0x0000FF));
